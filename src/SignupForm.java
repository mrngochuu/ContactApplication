...
public class SignupForm extends javax.swing.JFrame {
    ...
    private void setDefaultImg() {
        lblPic.setIcon(resizePic("src/img/Unknown.png"));
        setImgbinary("src/img/Unknown.png");
    }
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        Connection con = ConnectionDB.connectDB(driver, url);
        try {
            PreparedStatement ps = con.prepareStatement("INSERT INTO tblusers (firstName,lastName,userName,password,picture) values (?,?,?,?,?)");
            ps.setString(1, txtFirstName.getText());
            ps.setString(2, txtLastName.getText());
            ps.setString(3, txtUsername.getText());
            ps.setString(4, HashPassword.generateHash(String.valueOf(txtPassword.getPassword())));
            ps.setBytes(5, img);
    ...
    private ImageIcon resizePic(String picPath) {
        ...
        Image img = icon.getImage().getScaledInstance(lblPic.getWidth(), lblPic.getHeight(), Image.SCALE_SMOOTH);
    ...
    private void setImgbinary(String path) {
        try {
